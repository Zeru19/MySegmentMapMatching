...
class Matcher:
    ...
    def _load_graph(self, graph, extent):
        ...
        self.edge_info = edge_info[['edge', 'edge_name', 'o', 'd', 'length', 'highway', 'longitude', 'latitude', 
                                    'longitude_o', 'latitude_o', 'street_count_o', 'longitude_d', 'latitude_d', 'street_count_d']]
