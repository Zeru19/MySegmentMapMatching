...
trips.to_hdf('exports/chengdu.h5', key='trips')
trip_info.to_hdf('exports/chengdu.h5', key='trip_info')
road_info.to_hdf('exports/chengdu.h5', key='road_info')
